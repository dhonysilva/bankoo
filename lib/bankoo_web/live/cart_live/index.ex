defmodule BankooWeb.CartLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :carts, ShoppingCart.list_carts())}
  end
  ...
  @impl true
  def handle_info({BankooWeb.CartLive.FormComponent, {:saved, cart}}, socket) do
